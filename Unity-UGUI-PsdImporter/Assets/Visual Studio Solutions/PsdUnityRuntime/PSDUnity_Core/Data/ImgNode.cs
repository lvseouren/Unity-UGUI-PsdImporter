...
namespace PSDUnity.Data
{
    ...
    public class ImgNode : INameAnalyzing<Data.ImgNode>
    {
        ...
        public bool IsBigger(ImgNode node)
        {
        ...
        {
            this.Name = Rule ? Rule.AnalySisImgName(name, out source, out type) : name;
            this.customNameType = Rule?Rule.nameType:SuffixType.None;
            this.forceAddress = Rule?Rule.forceAddress:false;
            //添加后缀
            if (texture != null)
            {
